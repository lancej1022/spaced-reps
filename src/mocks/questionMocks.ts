...
const questionMocks: [string, ReminderInterface][] = [
  [
    "'K' Closest Numbers ",
    {
      ...
      timeStamp: '2022-09-24T20:35:00.904Z',
  ...
  [
    "'K' Closest Points to the Origin ",
    {
      ...
      timeStamp: '2022-09-15T19:57:33.503Z',
  ...
  [
    'Balanced Parentheses ',
    {
      ...
      timeStamp: '2022-09-14T17:39:15.880Z',
  ...
  [
    'Connect Ropes ',
    {
      ...
      timeStamp: '2022-09-23T05:32:29.948Z',
  ...
  [
    'Dutch National Flag Problem ',
    {
      ...
      timeStamp: '2022-09-13T22:38:55.561Z',
  ...
  [
    'Employee Free Time',
    {
      ...
      notes:
        'create a helper class EmployeeInterval that accepts an interval, an employeeIndex (used to track which employee it is from the original array), and an intervalIndex (used to track which interval this is for the employee).\n\nIn the main function, create a MinHeap, where the compareFunc is based on `a.interval.start < b.interval.start`. \nLoop over the input schedule and insert a new EmployeeInterval(input[i][0], i, 0). \nThis will find gaps between any employees FIRST schedules (since one employee might have multiple schedules, we will process those later.\n\nThen, create a `popped` variable and a previousInterval variable that points to minHeap.peek().\n\nwhile the minHeap has length, remove from the minHeap and assign it to `popped`. \nIF prevInterval.end < popped.start, then push a new interval into the results array based on `prev.end, popped.start`. \nThen, reassign prev to popped.interval.\n\nElse if prev.end < popped.end then we have an overlaping interval, so we reassign prev to the popped interval (???)\n\noutside of the above if/else if, look up the employeeSchedule via input[popped.employeeIndex and save it to a variable. \nIf that employeeSchedule.length is greater than the popped intervalIndex + 1, then we still have more intervals for the same employee to process so we insert another EmployeeInterval into the minHeap, passing in `employeeSchedule[popped.intervalIndex + 1], employeeIndex, and popped.intervalIndex + 1.\n\nThat wraps up the while loop, so now you can return the result arr',
      timeStamp: '2022-09-24T02:22:11.809Z',
  ...
  [
    'Evaluate Expression',
    {
      ...
      timeStamp: '2022-09-23T05:44:52.020Z',
  ...
  [
    'Find the First K Missing Positive Numbers',
    {
      ...
      timeStamp: '2022-09-23T17:49:31.043Z',
  ...
  [
    'Find the Median of a Number Stream ',
    {
      ...
      timeStamp: '2022-09-06T17:03:07.936Z',
  ...
  [
    'Happy Number ',
    {
      ...
      timeStamp: '2022-09-15T19:25:04.261Z',
  ...
  [
    'Intervals Intersection ',
    {
      ...
      timeStamp: '2022-09-20T02:24:14.298Z',
  ...
  [
    'Kth Largest Number in a Stream ',
    {
      ...
      timeStamp: '2022-09-17T23:47:56.850Z',
  ...
  [
    'Kth Smallest Number in M Sorted Lists ',
    {
      ...
      notes:
        "Create a minHeap.\nLoop over the input arrays and insert a tuple in the form of [value, index = 0, source array].\nWe'll use the value in the tuple both for comparing within our maxHeap as well as the return value at the end.\nThe index helps us keep track of where we are within an individual array, and we'll increment it each time we re-push.\nThe source array is obviously used so we can iterate through the array until we reach the kth smallest element amongst all arrays.\n\nSet a counter to 0, then loop while the minHeap has length and count is less than k - 1 (because we dont want to remove the kth element).\nEach loop, remove the min element and increment count.\nif the sourceArr has another element in it (index + 1 !== undefined) then repush the tuple, while updating the value and index.\n\nAt the end, return the minHeap.peek()",
      timeStamp: '2022-09-06T04:02:48.702Z',
  ...
  [
    'Laptop Rentals',
    {
      ...
      timeStamp: '2022-09-15T19:19:04.006Z',
  ...
  [
    'Longest Substring with Same Letters after Replacement ',
    {
      ...
      notes:
        'Use for loop + sliding window + frequency Map. \n\nTrack max repeating letter in a variable, recalculate via Math.max in each loop. \nThen, IF the current window is bigger than max repeating char + k, slide the window. \nAt end of each for loop, Math.max `maxLengthSeen`',
      timeStamp: '2022-09-23T18:00:31.959Z',
  ...
  [
    'Maximum CPU Load',
    {
      ...
      timeStamp: '2022-09-20T22:08:02.730Z',
  ...
  [
    'Maximum Distinct Elements ',
    {
      ...
      timeStamp: '2022-09-20T02:37:13.347Z',
  ...
  [
    'Merge Intervals ',
    {
      ...
      timeStamp: '2022-09-13T23:14:55.150Z',
  ...
  [
    'Next Letter ',
    {
      ...
      timeStamp: '2022-09-21T18:28:32.992Z',
  ...
  [
    'Node Depths',
    {
      ...
      timeStamp: '2022-09-24T18:55:16.483Z',
  ...
  [
    'Order-agnostic Binary Search ',
    {
      ...
      timeStamp: '2022-09-21T18:53:40.150Z',
  ...
  [
    'Permutations ',
    {
      ...
      timeStamp: '2022-09-24T21:38:59.200Z',
  ...
  [
    'Remove Duplicates From Linked List',
    {
      ...
      timeStamp: '2022-09-23T17:44:25.609Z',
  ...
  [
    'Reverse a Sub-list ',
    {
      ...
      timeStamp: '2022-09-25T00:50:51.126Z',
  ...
  [
    'Sum of Elements ',
    {
      ...
      timeStamp: '2022-09-19T23:52:36.581Z',
  ...
  [
    "Top 'K' Frequent Numbers ",
    {
      ...
      timeStamp: '2022-09-06T03:55:51.643Z',
  ...
  [
    'Unique Generalized Abbreviations ',
    {
      ...
      timeStamp: '2022-09-24T22:43:16.542Z',
  ...
  [
    'Validate Subsequence',
    {
      ...
      timeStamp: '2022-09-23T06:09:18.851Z',
